...
if __name__ == "__main__":
    ...
    densities = [1.75, 1.80, 1.85, 1.90, 1.95]  # g/cm³, nominal is 1.85
    ...
    plt.savefig(REPO_ROOT / "figures" / "be_density_sensitivity_results.png", dpi=300)
